...
<main class="flex-1 bg-lightbg px-8 py-16 pb-24">
    <div class="max-w-7xl mx-auto">
        <header class="mb-16 text-center">
            <span class="text-skyblue font-black uppercase tracking-[0.4em] text-[10px] mb-4 block">Official Curator</span>
            <h1 class="text-5xl font-black text-brandblue uppercase italic mb-6">Batam Tour Packages</h1>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            @empty
                <div class="col-span-full py-20 text-center">
                    <p class="text-slate-400 font-bold">No tours found in this category.</p>
                </div>
            @endforelse
        </div>
    </div>
