                ...
                <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-slate-100">
                    ...
                    <div class="space-y-6">
                        ...
                        <div x-show="!coverPreview && '{{ $armada->image }}'" class="relative group aspect-video rounded-3xl overflow-hidden border border-slate-100 shadow-sm">
                            <img src="{{ Str::startsWith($armada->image, 'http') ? $armada->image : asset('storage/' . $armada->image) }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
