...
<div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
    <div>
        <h2 class="text-3xl font-black text-slate-800 uppercase italic tracking-tight">{{ __('Edit Fleet') }}: {{ $armada->name }}</h2>
        <p class="text-slate-500 text-sm mt-2 font-medium">{{ __('Update your transportation vehicle information.') }}</p>
    </div>
