...
<div class="mb-8">
    ...
    <h2 class="text-2xl font-bold text-slate-800">Edit Paket Tour: {{ $tour->title }}</h2>
    <p class="text-slate-500 text-sm">Perbarui rincian destinasi dan harga paket wisata kamu.</p>
</div>
