...
<div class="mb-10">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-3xl font-black text-slate-800 tracking-tight">{{ __('Launch Campaign') }}</h2>
            <p class="text-slate-500 text-sm font-medium">{{ __('Create a new promotional offer for the website.') }}</p>
        </div>
    </div>
</div>
...
<div class="max-w-5xl" x-data="{ 
    ...
    <form action="{{ route('admin.promotions.store') }}" method="POST" enctype="multipart/form-data" class="space-y-12">
        @csrf
                ...
                <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-slate-100">
                    ...
                    <div class="grid grid-cols-1 gap-8">
                        <div>
                            ...
                            <input type="text" name="title" id="title" class="w-full px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-bold text-slate-700" placeholder="{{ __('Example: Batam Weekend Getaway') }}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" class="w-full px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium text-slate-600 resize-none leading-relaxed" placeholder="{{ __('Describe the promotion details...') }}"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-slate-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <div class="relative">
                                <select name="type" id="type" class="w-full px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 appearance-none cursor-pointer">
                                    <option value="general">{{ __('General / Manual') }}</option>
                                    <option value="tour">{{ __('Tour Package') }}</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="link" id="link" class="w-full px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-bold text-slate-700" placeholder="{{ __('Example: /tours') }}">
                        </div>

                        <div>
                            <label for="link_text" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">{{ __('Button Text') }}</label>
                            <input type="text" name="link_text" id="link_text" class="w-full px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-bold text-slate-700" placeholder="{{ __('Example: Book Now') }}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <label for="image" class="flex flex-col items-center justify-center w-full py-12 border-2 border-dashed border-slate-200 rounded-3xl cursor-pointer hover:bg-slate-50 transition-all group px-4 text-center">
                                ...
                                <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">{{ __('Upload Banner Image') }}</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-slate-100">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <input type="text" name="badge" id="badge" class="w-full px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-black text-red-500" placeholder="{{ __('Example: FLASH SALE') }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="expires_at" id="expires_at" class="w-full px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-bold text-slate-700">
                        </div>
                        ...
                        <label class="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl cursor-pointer hover:bg-slate-100 transition-all border border-slate-100">
                            <input type="checkbox" name="is_active" id="is_active" value="1" checked class="w-6 h-6 text-blue-600 border-slate-300 rounded-lg focus:ring-blue-500 transition-all">
